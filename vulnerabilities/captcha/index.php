...
$page[ 'body' ] .= "
	...
	<h1>Información de usuario: Cambio de nombre</h1>
...
$page[ 'body' ] .= ">
			<h3>Aquí puedes actualizar o corregir tu nombre personal de nuestra base de datos. *No confundir con nombre de usuario</h3>
			<br />
...
$page[ 'body' ] .= "			Nuevo nombre:<br />
			<input type=\"password\" AUTOCOMPLETE=\"off\" name=\"password_new\"><br />
			<br/>Confirmar nuevo nombre:<br />
