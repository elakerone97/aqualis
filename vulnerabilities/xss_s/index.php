...
<div class=\"body_padded\">
	...
	<div class=\"vulnerable_code_area\">
		<p>Aquí puedes ver las opiniones y comentarios de otros usuarios sobre nuestra tienda.</p>
		<form method=\"post\" name=\"guestform\" \">
			<table width=\"550\" border=\"0\" cellpadding=\"2\" cellspacing=\"1\">
				...
				<tr>
					<td width=\"100\">&nbsp;</td>
					<td>
						<input name=\"btnSign\" type=\"submit\" value=\"Enviar comentario\" onclick=\"return validateGuestbookForm(this.form);\" />
						<input name=\"btnClear\" type=\"submit\" value=\"Vaciar buzón\" onClick=\"return confirmClearGuestbook();\" />
					</td>
				</tr>
			</table>\n";
