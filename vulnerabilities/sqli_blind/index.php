...
<div class=\"body_padded\">
	<h1 style=\"line-height: 1.3;\">Busca por ID de empleado y verifica que tu contacto trabaja para Aqualis</h1>

	{$WarningHtml}

	<div class=\"vulnerable_code_area\">";
if( $vulnerabilityFile == 'high.php' ) {
	$page[ 'body' ] .= "Pulsa <a href=\"#\" onclick=\"javascript:popUp('cookie-input.php');return false;\">aquí para buscar por ID</a>.";
}
else {
	$page[ 'body' ] .= "
		<form action=\"#\" method=\"{$method}\">
			<p>
				<b>Si no estás seguro, busca aquí el ID del dependiente con el que hablaste</b></br><br/>";
	if( $vulnerabilityFile == 'medium.php' ) {
		$page[ 'body' ] .= "\n				ID de empleado: <select name=\"id\">";
		...
		$page[ 'body' ] .= "\n				ID de empleado: <input type=\"text\" size=\"15\" name=\"id\">";
