<div class="body_padded">
	...
	<td><div id="code">
		...
		<h3>Medium Level</h3>
		<p>This stage adds a sleep on the failed login screen. This mean when you login incorrectly, there will be an extra 1 second wait before the page is visible.</p>
