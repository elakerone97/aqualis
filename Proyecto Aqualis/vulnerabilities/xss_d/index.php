...
<div class="body_padded">
	...
	<div class="vulnerable_code_area">
 		...
 		<p>Por favor, selecciona el idioma en el que quieres navegar por la web.</p>
		<p><i>*En construcción. Idioma(s) disponible(s): Español.</i></p>
		...
		<form name="XSS" method="GET">
			<select name="default">
				<script>
					...
					document.write("<option value='Espanol'>Español</option>");
					document.write("<option value='Frances'>Frances</option>");
					document.write("<option value='Ingles'>Ingles</option>");
					document.write("<option value='Aleman'>Aleman</option>");
				</script>
			</select>
